...
////////////////////////////////////////////
	var dolist = "<span id='battleorders_do'><h1 style='clear:left' class='noborder'>DO csaták</h1><iframe class='media_widget' ";
	...
	var priolist = "<span id='battleorders_prio'><h1 style='clear:left' class='noborder'>Priós csaták</h1><iframe class='media_widget' ";
        ...
        if ($('#orderContainer').length) {
            $("#orderContainer").after(dolist);
            $("#battleorders_do").after(priolist);
        } else if ($('#pvp').length) {
            var box = "<div width=100% style='display:table'><div style='display:table-cell;'>" + dolist + "</div><div style='display:table-cell;'>"+ priolist + "</div></div>";
            $("#pvp").after(box);
        } else if ($('.listing resistance').length) {
            $(".listing resistance").after(dolist);
            $("#battleorders_do").after(priolist);
        } else if ($('#battle_listing').length) {
            $("#battle_listing").after(dolist);
            $("#battleorders_do").after(priolist);
        }
